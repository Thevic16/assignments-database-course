USE [master]
GO
/****** Object:  Database [academica]    Script Date: 12/9/2020 2:56:34 p. m. ******/
...
USE [academica]
GO
/****** Object:  Table [dbo].[asignatura]    Script Date: 12/9/2020 2:56:35 p. m. ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[estudiante]    Script Date: 12/9/2020 2:56:35 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[grupo]    Script Date: 12/9/2020 2:56:35 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[inscripción]    Script Date: 12/9/2020 2:56:35 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[período académico]    Script Date: 12/9/2020 2:56:35 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
ALTER TABLE [dbo].[inscripción]  WITH CHECK ADD  CONSTRAINT [FK_inscripción_asignatura] FOREIGN KEY([código de la asignatura])
REFERENCES [dbo].[asignatura] ([código])
GO
ALTER TABLE [dbo].[inscripción] CHECK CONSTRAINT [FK_inscripción_asignatura]
GO
